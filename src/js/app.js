...
/**
 * generateCard() function will create programmatically HTML element li, i with
 * the class 'card', 'fa-diamond', 'fa-cube' etc.
 */
...
/**
 * renderCard() function will select deck iterate the card array as into variable 'cardHTML'
 * and return array as HTML render card as HTML elements using the generateCard() function
 *
 */
function renderCard() {
...
function checkCardMatch() {
  if (openedCards.length === 2) {
    cardMoveCounter();
    if (
      openedCards[0].querySelector("i").classList.value ===
